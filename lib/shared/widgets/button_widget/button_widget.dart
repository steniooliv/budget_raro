...
const CustomButton.add({
  ...
  Widget build(BuildContext context) {
    List<Widget> content =[];
    if (aux == 1) {
      content =[Text(buttonContent, style: TextStyles.textButton,), Icon(icon, color: Colors.white,)];
    }
    if (aux == 2){
      content =[Icon(icon, color: Colors.white,), Text(buttonContent, style: TextStyles.textButton,)];
    }
    if (aux == 3) {
      content =[Text(buttonContent, style: TextStyles.textButton,)];
    }
