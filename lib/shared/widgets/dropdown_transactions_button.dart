...
import 'package:budget_raro/shared/widgets/transaction_types.dart';
...
class DropdownTransactionsButton extends StatefulWidget {
  ...
  @override
  _DropdownTransactionsButtonState createState() =>
      _DropdownTransactionsButtonState();
}

class _DropdownTransactionsButtonState
    extends State<DropdownTransactionsButton> {
  TransactionTypes? transactionSelected;

  @override
  Widget build(BuildContext context) {
    List<TransactionTypes> transactions =
    ...
    return DropdownButton<TransactionTypes>(
      ...
      selectedItemBuilder: (BuildContext context) {
        return transactions.map<Widget>((TransactionTypes item) {
          return Align(
              alignment: Alignment.centerLeft,
              child: Container(
                  width: 220,
      ...
      items: transactions.map<DropdownMenuItem<TransactionTypes>>(
